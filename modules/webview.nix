    ...
    source.dirs."robotnix/webview-overlay".src = pkgs.writeTextFile {
      ...
      text =
        ...
        + (lib.concatMapStringsSep "\n" (
          m:
          lib.optionalString m.enable "<webviewprovider description=\"${m.description}\" packageName=\"${m.packageName}\" availableByDefault=\"${lib.boolToString m.availableByDefault}\" isFallback=\"${lib.boolToString m.isFallback}\"></webviewprovider>"
