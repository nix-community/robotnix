    ...
    let
      ...
      kernelDirs =
        ...
        // optionalAttrs (elem kernelName [ "redfin" ]) {
          ...
          "arch/arm64/boot/dts/vendor/qcom/camera" =
            fetchRepo "private/msm-google/arch/arm64/boot/dts/vendor/qcom/camera";
          "arch/arm64/boot/dts/vendor/qcom/display" =
            fetchRepo "private/msm-google/arch/arm64/boot/dts/vendor/qcom/display";
        };
    in
