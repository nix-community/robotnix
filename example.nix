...
with lib;
{
  ...
  apps = {
    webview = {
      ...
      apk = fetchurl {
        url = "https://github.com/bromite/bromite/releases/download/77.0.3865.81/arm64_SystemWebView.apk";
        sha256 = "19c24gw621gqyqrbn76p1zjl1qpvv5v3nq404vjqhdyjr84xr2hy";
      };
    };
