...
let
  ...
  bromite_src = fetchFromGitHub {
    ...
    repo = "bromite";
    #rev = version;
    # Needs a fix in the commit right after the tag to compile
    rev = "46701c75ededd5c2d19b5039bd54ac279198103a";
    sha256 = "0wah0yzibp5hybwb7shrapbqs08yhr06sm0d7slhva96kn3p2f7a";
  };
